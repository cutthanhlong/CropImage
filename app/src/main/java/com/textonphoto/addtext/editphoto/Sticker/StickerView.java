...
public abstract class StickerView extends FrameLayout {
    ...
    private void init(Context context){
        ...
        this.iv_scale.setImageResource(R.drawable.ic_ratio);
        this.iv_delete.setImageResource(R.drawable.ic_close);
        this.iv_flip.setImageResource(R.drawable.ic_hori);
    ...
    public void setStickerViewSelectedListener(StickerViewSelectedListener stickerViewSelectedListener) {
        this.H = stickerViewSelectedListener;
    }
