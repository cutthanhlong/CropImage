...
public class HorizontalProgressWheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(mCanvasClipBounds.centerX(), mCanvasClipBounds.centerY() - mProgressLineHeight / 3.0f, mCanvasClipBounds.centerX(), mCanvasClipBounds.centerY() + mProgressLineHeight / 3.0f, mProgressMiddleLinePaint);
